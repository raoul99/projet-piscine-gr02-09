...
<head>
   ...
   <link rel="stylesheet" type="text/css" href="gestionvendeur.css">
...
if (isset($_POST['button2'])) {
	if ($db_found) {
		$sql = "SELECT * FROM vendeur";
			...
			$sql .= " WHERE Pseudo LIKE '%$pseudo%' AND  Mail LIKE '%$mail%' ";
			

		$result = mysqli_query($db_handle, $sql);
		if (mysqli_num_rows($result) == 0) {

			echo "Le compte vendeur n'existe pas. <br>";
			echo "<a href='gestionvendeur.html' style='color:black'>"."<strong>"."Retourner a la page supprimer"."</strong>"."</a>";
} 		else {
			while ($data = mysqli_fetch_assoc($result) ) {
				...
				$sql = "DELETE FROM vendeur WHERE Mail = '$mail' ";
	...
	echo "Erreur champs vide : $erreur";
	echo "<a href='gestionvendeur.html' style='color:black'>"."<strong>"."Retourner a la page supprimer"."</strong>"."</a>";
}
