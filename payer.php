...
<?php
    ...
    $database="pscine4";
     ...
     $db_found = mysqli_select_db($db_handle, $database);
        ...
        if ($_POST["button1"]) {
          if ($db_found) {
            if ($carte=="" || $num=="" || $nomc="" || $date=="" || $code=="" ) {

                  echo "*champs vides"."<br>";
                echo "<a href='payer.html' style='color:black'>"."<strong>"."Retourner a la page de payement"."</strong>"."</a>";
            }
             ...
             if ($carte != "" && $num!="" && $nomc!="" && $date!="" && $code!="") {
                 ...
                 $sql .= " WHERE Typedecarte='%$carte%' AND Numerodelacarte = '%$num%' AND Nomaffichedanslacarte = '%$nomc%' AND expiration = '%$date%' AND Codedesecurite = '%$code%'";
             ...
             if (mysqli_num_rows($result) == 0) {
                ...
                echo "Erreur lors de la saisie des informations, veuillez recommencer"."<br>";
                echo "<a href='payer.html' style='color:black'>"."<strong>"."Retourner a la page de payement"."</strong>"."</a>";
                ...
                echo "<h1>"."Felicitations, ACHAT EFFECTUE"."</h1>"."<br>";
                echo "<a href='paged'acceuil.html' style='color:black'>"."<strong>"."Retourner a la page d'acceuil"."</strong>"."</a>";
